...
<ul class="param-ul">
  ...
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">Options for the revert operation.</p>
    <ul class="param-ul">
      <li class="param-li">
      ...
      <li class="param-li">
        ...
        <br>
        <p class="param-description">Parent number for merge commits (1-based).  When reverting a merge commit, the mainline parent is the one you want to revert to. The mainline is the branch into which the merge was made.</p>
      </li>
      <li class="param-li">
...
<ul class="param-ul">
  ...
  <li class="param-li param-li-root">
    <span class="param-type">Error</span>
    <br>
    <p class="param-description">If there are conflicts during the revert operation.</p>
  </li>
</ul>
