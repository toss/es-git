...
<ul class="param-ul">
  ...
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">Options for the cherrypick operation.</p>
    <ul class="param-ul">
      <li class="param-li">
        <span class="param-name">checkoutOptions</span><span class="param-type">CheckoutOptions</span>
        <br>
        <p class="param-description">Options for checkout behavior when updating working directory.</p>
        <ul class="param-ul">
          <li class="param-li">
      ...
      <li class="param-li">
        ...
        <br>
        <p class="param-description">Parent number for merge commits (1-based).  When cherrypicking a merge commit, the mainline parent is the one you want to cherrypick from. The mainline is the branch from which the merge was made.</p>
      </li>
      <li class="param-li">
        <span class="param-name">mergeOptions</span><span class="param-type">MergeOptions</span>
        <br>
        <p class="param-description">Options for merge resolution when cherrypicking a merge commit.</p>
        <ul class="param-ul">
          <li class="param-li">
...
<ul class="param-ul">
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">If the commit is a merge commit and no mainline is specified.</p>
  </li>
  <li class="param-li param-li-root">
    <span class="param-type">Error</span>
    <br>
    <p class="param-description">If there are conflicts during the cherrypick operation.</p>
  </li>
</ul>
