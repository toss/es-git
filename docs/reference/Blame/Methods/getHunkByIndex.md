...
<ul class="param-ul">
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">Index of the hunk to get (0-based)</p>
  </li>
</ul>
...
<ul class="param-ul">
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">Blame information for the specified index</p>
    <ul class="param-ul">
      <li class="param-li">
...
<ul class="param-ul">
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">If no hunk is found at the index</p>
  </li>
</ul>