...
<ul class="param-ul">
  <li class="param-li param-li-root">
    <span class="param-name">line</span><span class="param-required">필수</span>&nbsp;·&nbsp;<span class="param-type">number</span>
    <br>
    <p class="param-description">blame 정보를 가져올 줄 번호 (1부터 시작)</p>
  </li>
</ul>
...
<ul class="param-ul">
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">지정된 줄에 대한 blame 정보</p>
    <ul class="param-ul">
      <li class="param-li">
      ...
      <li class="param-li">
        ...
        <ul class="param-ul">
          ...
          <li class="param-li">
            ...
            <br>
            <p class="param-description">epoch로부터 초 단위 시간</p>
          </li>
        </ul>
      </li>
      <li class="param-li">
        ...
        <br>
        <p class="param-description">최종 파일에서 이 hunk가 시작하는 1부터 시작하는 줄 번호.</p>
      </li>
      <li class="param-li">
      ...
      <li class="param-li">
        ...
        <br>
        <p class="param-description">이 줄이 최초로 작성된 커밋의 oid.</p>
      </li>
      <li class="param-li">
        <span class="param-name">origSignature</span><span class="param-type">Signature</span>
        <br>
        <p class="param-description">이 줄이 최초로 작성된 커밋의 서명.</p>
        <ul class="param-ul">
          <li class="param-li">
            <span class="param-name">email</span><span class="param-required">필수</span>&nbsp;·&nbsp;<span class="param-type">string</span>
            <br>
      ...
      <li class="param-li">
        ...
        <br>
        <p class="param-description">원본 파일에서 이 hunk가 시작하는 1부터 시작하는 줄 번호.</p>
      </li>
      <li class="param-li">
        <span class="param-name">path</span><span class="param-type">string</span>
        <br>
        <p class="param-description">이 줄이 최초로 작성된 파일의 경로.</p>
      </li>
    </ul>
  </li>
</ul>
...
<ul class="param-ul">
  <li class="param-li param-li-root">
    ...
    <br>
    <p class="param-description">해당 줄에 대한 hunk를 찾을 수 없는 경우</p>
  </li>
</ul>